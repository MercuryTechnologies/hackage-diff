  ...
  outputs = { self, nixpkgs, flake-utils }:
    let
      ...
      out = system:
        ...
        {
          packages = rec {
            default = hackage-diff;
            hackage-diff = pkgs.haskell.packages.${ghcVer}.hackage-diff;
          };

          checks = {
            inherit (self.packages.${system}) hackage-diff;
          };
          ...
          devShells.default =
            ...
            haskellPackages.shellFor {
              packages = p: [ self.packages.${system}.hackage-diff ];
              withHoogle = true;
    ...
    flake-utils.lib.eachDefaultSystem out // {
      ...
      overlays = {
        default = makeHaskellOverlay (prev: hfinal: hprev:
          ...
          {
            hackage-diff = hprev.callCabal2nix "hackage-diff" ./. { };
